 ...
 * @return {any}
 */
export function read_pratr($elem: JQuery, prop: string): any {
 ...
 * @return {String}
 */
export function getName($elem: JQuery): string {
...
export function esc_quot(str): string {
    return String(str).replace(_eq_r_, "\\$&");
}
export function is_domain(str): boolean {
    return _is_domain_r_.test(str);
}
export function is_url(str): boolean {
    return _is_url_r_.test(str);
}
export function is_email(str): boolean {
...
export const isEventSupported = (function (_doc) {
    ...
    function isEventSupported(eventName, document = _doc): boolean {
